...
if($data_list_cnt > 0) {	
	for ($i=0; $i<$data_list_cnt; $i++ ) {
			...
			$jb_etc3				= date("Y.m.d", strtotime($data_list[$i]['jb_etc3']));
		...
		//	$jb_title = $depth_icon . $jb_title . $comment_count . $new_icon; //이미지타이틀 처리
			...
			echo ("
					<li>
						...
						<dl class='info media-center'>
							<dt class='none'>글 제목</dt><dd class='subject'><strong>".${jb_title}."</strong></dd>
						</dl>
							<p class='center-text'>".${jb_content}."</p>
						<dl class='info'>
							<dt class='none'>글 등록일</dt><dd class='date'>".${jb_etc3}."</dd>
							<dt>No. </dt><dd>". $num_idx--."</dd>
						</dl>
						</a>
					</li>
				");
