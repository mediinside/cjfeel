...
<form name="frm_Board" id="frm_Board" action="<?=$get_par?>" method="post" enctype="multipart/form-data">
 ...
 <table class="board-write">
      ...
      <tr>
        ...
        <tr>
          <th scope="row">나이</th>
          <td><input type="text" class="i_text full" title="나이 입력" placeholder="나이를 입력해 주세요." id="jb_age" name="jb_age" value="<?=$jb_age?>" /></td>
        </tr>
        <tr>
          <th scope="row">이름</th>
          <td><input type="text" class="i_text full" title="이름 입력" placeholder="이름을 입력해 주세요."id="jb_name" name="jb_name" value="<?=$jb_name?>" /></td>
        </tr>
         <tr>
          <th scope="row">원장님</th>
          <td><input type="text" class="i_text full" title="원장님 입력" placeholder="원장님을 입력해 주세요." id="jb_etc1" name="jb_etc1" value="<?=$jb_etc1?>" /></td>
        </tr>
		<? if($check_level >= 9){?>
        <tr>
