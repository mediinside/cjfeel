  ...
  <input type="hidden" id="jb_email" name="jb_email" value="<?=$_SESSION['suseremail']?>" />
    <table class="board-write">
      ...
      <tr>
          ...
          <td><input type="text" class="i_text middle datepicker" title="작성일자 입력" placeholder="작성일자를 입력해 주세요."id="jb_etc3" name="jb_etc3" /></td>
        </tr>  
       <tr>
          <th scope="row">제목</th>
        ...
        <tr>
          <th scope="row">식단</th>
          <td><input type="text" class="i_text full" title="식단 입력" placeholder="식단을 입력해 주세요."id="jb_name" name="jb_name" /></td>
        </tr>
		 <? if($check_level >= 9){?>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" class="txt full" title="비밀번호 입력" placeholder="비밀번호를 입력해 주세요." id="jb_password" name="jb_password" /></td>
        </tr>
        <?php
        } else {
        ...
        <tr>
          ...
          <td>
            ...
            if(isset($check_id) && $check_level>=9){
              echo "<label class='noti'><input type=\"checkbox\" value=\"Y\" id=\"jb_notice_check\" name=\"jb_notice_check\" class='chk'>BEST</label>";
            }
            ?>
          </td>
        </tr>
        <tr>
          ...
          <td class="files">
           <div class="inputFile">
          		<input type="text" class="i_text" placeholder="첨부파일 (270 X 324)" readonly />
   ...
   <div class="btn-group right">
    <a href="#;" id="img_submit" class="btn btn-middle btn-default">글쓰기</a>
