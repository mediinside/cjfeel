			...
			$jb_title = $depth_icon . $jb_title . $comment_count . $new_icon; //이미지타이틀 처리
				...
				echo ("
						<tr>
							...
							<td class='type'>${jb_name}</td>
							<td class='subject'><a href='" . $get_par . "'>${jb_title}<span class='${comment_class}'>${comment_txt}</span></a></td>
							<td class='name'>${jb_name}</td>
							<td lass='date'>${jb_reg_date}</td>
						</tr>
