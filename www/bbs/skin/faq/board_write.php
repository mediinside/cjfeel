...
<form name="frm_Board" id="frm_Board" action="<?=$get_par;?>" method="post" enctype="multipart/form-data">
  ...
  <table class="board-write">
    ...
    <tbody>
     <tr>
		...
		<tr>
          <th scope="row">제목</th>
          <td><input type="text" class="i_text full" title="제목 입력" autocomplete="off" placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" /></td>
        </tr>
         <? if($check_level >= 9){?>
        <tr>
          ...
          <? if($check_level < 9) {?>
            <tr>
              ...
              <td>
                ...
                <a href="#;" class="btn btn_small" onclick="document.getElementById('zsfImg').src='<?=$GP -> IMG_PATH?>/zmSpamFree/zmSpamFree.php?re&zsfimg=' + new Date().getTime(); return false;"><span>새로고침</span></a>
              </td>
            </tr>
            <? } ?>
      </tbody>
  ...
  <div class="btn-group right">
    <a href="#;" id="img_submit" class="btn btn-middle btn-green">글쓰기</a>
