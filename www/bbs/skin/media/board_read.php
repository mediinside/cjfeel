...
<div class="board-view">
 <dl class="header">
        <dt class="none">제목</dt>
        <dd class="subject"><?=$jb_title?></dd>
        <dt class="none">작성일</dt>
...
?>
  ...
  <div class="btn-group">
    <div class="btn-rt">
      <?php
				//글목록버튼
				echo "<a href=\"#\" onclick=\"javascript:location.href='${index_page}?jb_code=${jb_code}&${search_key}&search_keyword=${search_keyword}&page=${page}'\" class=\"btn btn-default\" title='목록'><span>목록</span></a>";	
				?>
   </div>
    <div class="btn-lt">
      <?
			...
			if($check_level >= 9 || $check_id == $jb_mb_id)
					echo "<a href=\"#\" onclick=\"javascript:location.href='${get_par}&jb_mode=tmodify'\" class=\"btn btn-default \" title=\"수정\"><span>수정</span></a> ";
			//삭제권한(쓰기권한이 있어야 삭제 가능)
			if($check_level >= 9 || $check_id == $jb_mb_id)
					echo "<a href=\"#\" onclick=\"javascript:location.href='${get_par}&jb_mode=tdelete'\" class=\"btn btn-default \" title=\"삭제\"><span>삭제</span></a> ";								
			//쓰기권한
