...
echo "<div class=\"reply_text\">";
  ...
  <div class="reply-text">
	<textarea rows="5" cols="20" name="jbc_content" id="jbc_content"></textarea>
	<div class="btn-group center">
   		 <a href="#;"  class="btn btn-middle btn-default" id="comment_submit"><span>답변 등록</span></a>
	</div>
  </div>
</div>
