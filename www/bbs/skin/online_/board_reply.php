...
<input type="hidden" id="jb_owner_id" name="jb_owner_id" value="<?=$jb_owner_id?>" />
 <table class="board-write">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">작성자</th>
          <td><input type="text" class="i_text" title="작성자 입력" placeholder="작성자를 입력해 주세요."id="jb_name" name="jb_name" value="<?=$check_name?>" /></td>
        </tr>
        <tr>
          <th scope="row">이메일</th>
          <td><input type="text" class="i_text full" title="이메일 입력" placeholder="이메일을 입력해 주세요." id="jb_email" name="jb_email" value="<?=$_SESSION['suseremail']?>" /></td>
        </tr> 
        <?php
        ...
        <tr>
          ...
          <td><input type="text" class="i_text" title="비밀번호 입력" placeholder="비밀번호를 입력해 주세요." id="jb_password" name="jb_password" /></td>
        </tr>
        <?php
        } else {
   ...
   <div class="btn-group right">
    <a href="#;" id="img_submit" class="btn btn-middle btn-default">답글쓰기</a>
