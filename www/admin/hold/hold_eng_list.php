<?php
    ...
    $args['ts_gubun'] = "eng";
	$data = "";
	$data = $C_Hold ->Slide_List(array_merge($_GET,$_POST,$args));
...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<button onClick="layerPop('ifm_reg','./hold_eng_reg.php', '100%', 650)"; class="btnSearch ">슬라이드 등록</button>
		</div>
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
										...
										$b_img = '';
										if($ts_img !=  '') {
											$b_img = "<img src='" . $GP -> UP_HOLD_URL . $ts_img . "' width='100px' />";
										}
	
										$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./hold_eng_edit.php?ts_idx=" . $ts_idx. "', '100%', 650)", 50,'');	
