...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>메인 고정 이미지 등록</strong></span>
		</div>
		<form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
		<input type="hidden" name="mode" id="mode" value="SLIDE_REG" />
        <input type="hidden" name="ts_gubun" value="kor" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody> 							          							
							...
							<tr>
								<th><span>*</span>이미지<br> (556 X 360)</th>
								<td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$('#img_submit').click(function(){			
			...
			$('#base_form').attr('action','./proc/hold_proc.php');
			$('#base_form').submit();
			return false;
		});					
